...
<body>
                        ...
                        <li class="nav-item dropdown mega-dropdown">
                            ...
                            <div class="dropdown-menu">
                                <div class="row">
                                    ...
                                    <div class="col pl-0">
                                        <ul class="list-style-none">
                                            <li><a class="dropdown-item" href="/user/notice">공지사항</a></li>
                                ...
                                <div class="col-auto px-0" data-dropdown-content>
                                    <div class="list-group list-group-flush">
                                        <a href="#" target="_blank"
                                            ...
                                            <div class="ml-4">
                                                <span class="text-dark d-block">온라인 사용 설명서<span
                    ...
                    <div class="modal-body p-0">
                        <div class="card bg-primary shadow-soft border-light p-4">
                            ...
                            <div class="card-header text-center pb-0">
                                <h2 class="mb-0 h5">${u.name}님의 정보 수정</h2>
                            </div>
                            <div class="card-body">
                                <form action="/user/modify" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-4">
                                            ...
                                            <input class="form-control" name="phone" id="exampleInputIcon4"
                                                value="${u.phone}" type="text" aria-label="email adress" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-4">
                                            ...
                                            <input class="form-control" id="exampleInputIcon4" name="address"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-4">
                                            ...
                                            <input class="form-control" id="exampleInputIcon4" name="postalCode"
                                                value="${u.postalCode}" type="text" >
                                        </div>
                                    </div>
                                    <!-- End of Form -->
                                    <div class="form-group">
                                        <!-- Form -->
                                        <div class="form-group">
                                            <label for="exampleInputPassword7">비밀번호</label>
                                            <div class="input-group mb-4">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><span
                                        ...
                                        <!-- Form -->
                                        <div class="form-group">
                                            <label for="exampleConfirmPassword7">비밀번호 변경</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-4 px-md-0 mb-4 mb-lg-0">
                                    <div class="card-body text-center bg-primary py-5">
                                        ...
                                        <!-- Text -->
                                        <p class="mb-0">자가 수리가 어려운 문제 혹은 부품 교체와 같은 문제는 전문 엔지니어가 고객님께 찾아가서 필요로 하시는 서비스를
                                            제공해드립니다.</p>
                                    </div>
                                </div>
                ...
                <div class="row align-items-center justify-content-around">
                    <div class="col-md-6 col-xl-6 mb-5">
                        <div class="card bg-primary shadow-soft border-light organic-radius p-3">
                            <img class="organic-radius img-fluid" src="/img/home_service_banner_02_211008.webp"
                                alt="modern desk">
                        </div>
                    </div>
                    <div class="col-md-6 col-xl-5 text-center text-md-left">
                        <h2 class="h2 mb-4">ISEC A/S는 고객을 위한 가치창조와 인간존중의 경영 및 서비스를 실현합니다.</h2>
                        <p class="lead">전 세계 고객의 문화적 특성과 생활 습관 등 고객연구를 기반으로 혁신적인 기술, 프리미엄 디자인을 결합한 시장 선도형 제품으로 글로벌 가전
                            시장을 선도하고 있으며,</p>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="accordion shadow-soft rounded" id="accordionExample1">
                            ...
                            <div class="card card-sm card-body bg-primary border-light">
                                <a href="#panel-4" data-target="#panel-4" class="accordion-panel-header"
                                ...
                                <div class="collapse" id="panel-4">
                                    <div class="pt-3">
                                        <p class="mb-0">
                                            섬유 유연제는 제조사 권장량으로 사용해주세요. 세탁기를 30회 이상 사용하셨거나, TCL문구가 보이시면 통살균 코스를 사용해보세요.
                                            염소계 표백제인 락스를 사용하여 통세척을 하신다면 소주 한 컵, 또는 종이컵 3분의 1 정도 ［54 밀리리터(ml)］를 세제 투입구에
                                            넣습니다.
                                            액체 염소계 표백제의 경우 액체 세제 투입구에 넣으시고, 분말 염소계 표백제의 경우 본 세탁용 세제 투입구에 넣으세요. (꼬망스 세탁기의
                                            경우 산소계 표백제 10ml를 넣으세요.)</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <footer class="d-flex pb-5 pt-6 pt-md-7 border-top border-light bg-primary">
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <p><strong>ISEC A/S</strong>에서는 오늘 하루도 고객의 불만과 불편을 듣고 해결하기 위해 최선을 다하고 있습니다. 최고의 품질과 서비스로 고객감동을 위한
                        실천을 최우선 자세로 삼고 있습니다. </p>
                ...
                <div class="col-12 col-lg-4 mb-5 mb-lg-0">
                    ...
                    <p class="text-gray font-small m-0">평일 근무시간 상담사가 문의 내용을 확인 후 답변하므로 주말 및 연휴에 문의하신 건의 답변은 지연될 수 있습니다.
                    </p>
                </div>
            </div>
            <hr class="my-5">
